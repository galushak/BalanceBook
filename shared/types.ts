...
export interface Tx extends Entity {type:EventType;date:string;accountId:string;toAccountId?:string;amount:number;principal?:number;interest?:number;subtype?:string;direction?:number;payeeId?:string;categoryId?:string;payee:string;category:string;notes:string;status:'ACTIVE'|'VOIDED';refundOf?:string;occurrenceId?:string;entries:Entry[];imported?:{source:string;recordId:number;original:Record<string,any>;readOnly?:boolean;reason?:string}}
